...
#define _UI_ARC_PROPERTY_VALUE 0
#define _UI_ARC_PROPERTY_VALUE_WITH_ANIM 1
    void _ui_arc_set_property(lv_obj_t *target, int id, int val);

    void _ui_checked_set_text_value(lv_obj_t *trg, lv_obj_t *src, const char *txt_on, const char *txt_off);

#define _UI_MODIFY_FLAG_TOGGLE 0
#define _UI_MODIFY_FLAG_ADD 1
#define _UI_MODIFY_FLAG_REMOVE 2
    void _ui_flag_modify(lv_obj_t *target, int32_t flag, int value);

#define _UI_MODIFY_STATE_TOGGLE 0
#define _UI_MODIFY_STATE_ADD 1
#define _UI_MODIFY_STATE_REMOVE 2
    ...
    void _ui_screen_delete(lv_obj_t **target, void (*target_destroy)(void));
