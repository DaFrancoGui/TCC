/**
 * @file lv_conf.h
 * @brief LVGL Configuration for Round Display (ESP32-C6)
 *
...
/* Montserrat fonts with Latin characters */
...
/* Select character encodings */
#define LV_TXT_ENC LV_TXT_ENC_UTF8

/* Line break characters */
#define LV_TXT_BREAK_CHARS " ,.;:-_"

/* Support bidirectional texts (Arabic, Hebrew, etc.) */
...
#define LV_USE_CHART 1 /* Para gráficos de sensores */
...
#define LV_USE_METER 1 /* Para medidores analógicos */
...
/* FFmpeg support for video and images */
...
/* Use GPU (not available on ESP32-C6) */
